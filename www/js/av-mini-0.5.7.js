/**
 * Created by kk on 15/9/24.
 */
!function (e) {
    e.AV = e.AV || {}, e.AV.VERSION = "js0.5.7"
}(this), function () {
    ...
    t.serverURL = "https://api.leancloud.cn", "undefined" != typeof process && process.versions && process.versions.node && (t._isNode = !0), t.initialize = function (e, n, i) {
        if (i)throw"AV.initialize() was passed a Master Key, which is only allowed from within Node.js.";
        t._initialize(e, n, i)
    }, t._initialize = function (e, n, i) {
        void 0 !== t.applicationId && console.warn("AVOSCloud SDK is already initialized, please don't reinitialize it."), t.applicationId = e, t.applicationKey = n, t.masterKey = i, t._useMasterKey = !1
    ...
    t.Relation = function (e, t) {
        if (!n.isString(t))throw TypeError("key must be a string");
    ...
    t.Promise = function (e) {
        ...
        _isPromisesAPlusCompliant: !t._isNode,
        _debugError: !1,
        setPromisesAPlusCompliant: function (e) {
            t.Promise._isPromisesAPlusCompliant = e
        },
        setDebugError: function (e) {
            t.Promise._debugError = e
        },
        is: function (e) {
        ...
        resolve: function () {
            ...
            var r = new t.Promise, s = function () {
                ...
                if (e)if (t.Promise._isPromisesAPlusCompliant)try {
                    ...
                    t.Promise._debugError && i && console.error("Error occurred in promise resolve callback.", i.stack || i), n = [t.Promise.error(i)]
                ...
                if (i) {
                    if (t.Promise._isPromisesAPlusCompliant)try {
                        ...
                        t.Promise._debugError && s && console.error("Error occurred in promise reject callback.", s.stack || s), n = [t.Promise.error(s)]
                    } else n = [i(e)];
                    1 === n.length && t.Promise.is(n[0]) ? n[0].then(function () {
                        r.resolve.apply(r, arguments)
                    }, function (e) {
            ...
            t.Promise._isPromisesAPlusCompliant && ("undefined" != typeof window && n.isFunction(window.setImmediate) ? o = function (e) {
                window.setImmediate(e)
            } : "undefined" != typeof process && process.nextTick ? o = function (e) {
                process.nextTick(e)
            } : "undefined" != typeof setTimeout && n.isFunction(setTimeout) && (o = function (e) {
                setTimeout(e, 0)
            }));
            var u = this;
    ...
    t.Object = function (e, i) {
        ...
        _existed: !1, _fetchWhenSave: !1, initialize: function () {
            ...
            return t.Object._findUnsavedChildren(d.attributes, f, _), f.length + _.length > 0 ? t.Object._deepSaveAsync(this.attributes, d).then(function () {
                ...
                d._fetchWhenSave && (i._fetchWhenSave = !0);
    ...
    t.Query = function (e) {
        ...
        _processResult: function (e) {
            ...
            if (!e) {
                var i = new t.Error(t.Error.OBJECT_NOT_FOUND, "Object not found.");
                return t.Promise.error(i)
            }
            var r = this;
            return r.equalTo("objectId", e), r.first().then(function (e) {
                if (!t._.isEmpty(e))return e;
    ...
    e.AV = e.AV || {};
    var t = e.AV, n = t._;
    t.Insight = t.Insight || {}, n.extend(t.Insight, {
        startJob: function (e, n) {
            if (!e || !e.sql)throw new Error("Please provide the sql to run the job.");
            var i = {
                jobConfig: e,
                appId: t.applicationId
            }, r = t._request("bigquery", "jobs", null, "POST", t._encode(i, null, !0));
            return r.then(function (e) {
                return t._decode(null, e).id
            })._thenRunCallbacks(n)
        }, on: function () {
        }
    }), t.Insight.JobQuery = function (e, t) {
        ...
        skip: function (e) {
            ...
            var n = {skip: this._skip, limit: this._limit}, i = t._request("bigquery", "jobs", this.id, "GET", n);
            return i.then(function (e) {
                return e.error ? t.Promise.error(new t.Error(e.code, e.error)) : t.Promise.as(e)
            })._thenRunCallbacks(e)
        }
    }
}(this), function (e) {
